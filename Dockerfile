...
COPY --chown=app:app favicon.ico server.py storage.py translate.py gunicorn.conf.py index.html account.html style.css cabinet.css profile-card.js app.js account.js cabinet.js i18n.js hero-loader.js hero-scene.js ./
